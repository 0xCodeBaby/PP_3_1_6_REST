...
public class Communication {
    ...
    public void saveUser(User user) {
        ...
        System.out.println("Пользователь был сохранен " + resultContent);
    }
    ...
    public void updateUser(User user) {
        ...
        resultContent.append(responseEntity.getBody());
        System.out.println("Пользователь был изменен " + resultContent);
    }
    ...
    public void deleteUser(User user, int id) {
        ...
        resultContent.append(responseEntity.getBody());
        System.out.println("Пользователь был удален " + resultContent);
    }
}
